...
let AppComponent = class AppComponent {
    constructor(renderer, http, uploadService) {
    ...
    startCamera() {
        if (!!(navigator.mediaDevices && navigator.mediaDevices.getUserMedia)) {
            navigator.mediaDevices.getUserMedia(this.constraints).then((ms) => this.attachVideo(ms));
...
let FormComponent = class FormComponent {
    ...
    ngOnInit() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(1000)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(Object.values(this.extractedData).length), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(i => [i, Object.values(this.extractedData)[i]]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(([i, val]) => this.formData[i] = val)).subscribe();
    }
    initFormData() {
        this.formData = {
            0: null,
...
], FormComponent.prototype, "extractedData", void 0);
FormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ../app.component.css */ "./src/app/app.component.css")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./form.component.css */ "./src/app/form/form.component.css")).default]
    })
], FormComponent);
...
module.exports = __webpack_require__(/*! /Users/smita.trivedi/code/big5-extract-ui/src/main.ts */"./src/main.ts");
